...
# What You'll Need
Java FX must be installed for this version.  However, in the next version we would like to make it an iOS feauture.  Additionally, the same data file is included in the repository.  This file is used to make matches.
